package com.lenerd.spotifyplus.module.lyrics;
...
public class LyricUtilities {
    ...
    public static TransformedLyrics transformLyrics(ProviderLyrics providedLyrics, Activity activity) {
        ...
        SpotifyPlusSettings.InterludeDuration interludeOption = SpotifyPlusSettings.interludeDuration;
        final int interludeDuration = interludeOption == SpotifyPlusSettings.InterludeDuration.BEAUTIFUL_LYRICS ? 2 : interludeOption == SpotifyPlusSettings.InterludeDuration.SPOTIFY_PLUS ? 4 : interludeOption == SpotifyPlusSettings.InterludeDuration.SPICY ? 3 : 8;
