...
public class GradientTextView extends TextView {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        float startFade = Math.max(
            0f,
            gradientProgress - (isLine ? fadeWidthLine : fadeWidth) / 2f
        );
        float endFade = Math.min(
            1f,
            gradientProgress + (isLine ? fadeWidthLine : fadeWidth) / 2f
        );
        ...
        if (!isLine) {
            if (gradientProgress <= 0f) {
                textShader = new LinearGradient(
                    ...
                    width,
                    0,
                    new int[]{gradientColors[1], gradientColors[1]},
                    null,
                ...
                textShader = new LinearGradient(
                    ...
                    width,
                    0,
                    new int[]{gradientColors[0], gradientColors[0]},
                    null,
                    Shader.TileMode.CLAMP
                );
            } else {
